...
CREATE TABLE ACCOUNT(ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL,CUSTOMER_ID INTEGER NOT NULL,DESCRIPTION VARCHAR(80),CREATED_AT DATE NOT NULL,FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER(ID))
