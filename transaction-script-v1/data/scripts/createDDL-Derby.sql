...
CREATE TABLE CUSTOMER_TRANSACTION (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL, SALE_ID INTEGER NOT NULL,CUSTOMER_ID INTEGER NOT NULL, CT_TYPE INTEGER NOT NULL, AMOUNT DOUBLE NOT NULL, CREATED_AT DATE NOT NULL, FOREIGN KEY (SALE_ID) REFERENCES SALE(ID), FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER(ID))
