 ...
 * 
 */
@WebFault(name = "ApplicationException", targetNamespace = "http://product.sale.handler.business/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: business.handler.sale.product.ApplicationException
     */
