 ...
 * generated in the business.handler package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetDiscounts_QNAME = new QName("http://handler.business/", "getDiscounts");
    private final static QName _GetDiscountsResponse_QNAME = new QName("http://handler.business/", "getDiscountsResponse");
    private final static QName _AddCustomerResponse_QNAME = new QName("http://handler.business/", "addCustomerResponse");
    private final static QName _ApplicationException_QNAME = new QName("http://handler.business/", "ApplicationException");
    private final static QName _AddCustomer_QNAME = new QName("http://handler.business/", "addCustomer");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: business.handler
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://handler.business/", name = "getDiscounts")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://handler.business/", name = "getDiscountsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://handler.business/", name = "addCustomerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://handler.business/", name = "ApplicationException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://handler.business/", name = "addCustomer")
